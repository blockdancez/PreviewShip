...
> One-click HTML/Markdown file hosting and static preview deployment from Cursor / VS Code.

PreviewShip allows you to publish the active `.html` or Markdown file, deploy static websites, host HTML/Markdown files online, and share AI-generated artifacts with one click inside Cursor / VS Code.
...
- **One-click Deployment**: Execute a command to package and upload the current workspace or active `.html`/Markdown file, automatically deploying to PreviewShip.
